...
public class LoginActivity extends Activity {
    ...
    /**
     * Intent filter action sent when the user cancels the login process
     */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Make this activity click-through
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);

        // Removed loader animation from this activity so it can be displayed inside the settings activity
    ...
    private void onAuthClientCompleted(AuthorizationClient.Result outcome) {
        ...
        // Notify Facebook for Muzei that the user has cancelled the login process
        if (resultCode == RESULT_CANCELED) {
            sendBroadcast(new Intent(ACTION_B_LOGIN_CANCELLED));
        }
