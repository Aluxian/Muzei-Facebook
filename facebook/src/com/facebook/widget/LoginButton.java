...
public class LoginButton extends Button {
    ...
    private OnClickListener additionalOnClickListener;
    ...
    private class LoginClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            if (additionalOnClickListener != null) {
                additionalOnClickListener.onClick(v);
            }
    ...
    /**
     * Allow the Facebook for Muzei app to get notified when the user clicks the login button
     *
     * @param onClickListener View.OnClickListener to be called
     */
    public void addAdditionalOnClickListener(OnClickListener onClickListener) {
        additionalOnClickListener = onClickListener;
    }
}
